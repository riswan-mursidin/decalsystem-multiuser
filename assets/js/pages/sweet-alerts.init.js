    ...
    function e(){}e.prototype.init=function(){
        t("#sa-basic").on("click",function(){
            ...
            Swal.fire({
                ...
                timer:2e3,confirmButtonColor:"#5664d2",
            ...
            Swal.fire({
                ...
                icon:"info",
                html:'You can use <b>bold text</b>, <a href="//themesdesign.in/">links</a> and other HTML tags',showCloseButton:!0,
                showCancelButton:!0,
            ...
            Swal.fire({
                ...
                Swal.mixin({
                    ...
                    t.value&&Swal.fire({
                        title:"All done!",
                        html:"Your answers: <pre><code>"+JSON.stringify(t.value)+"</code></pre>",confirmButtonText:"Lovely!"
                    })
                })
